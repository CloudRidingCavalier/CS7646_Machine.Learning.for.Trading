...
def computing_RMSE_CORR_BagLearner(trainX, trainY, testX, testY, primary_learner, max_leaf_size=None, max_bag_size=None, iterations=10):
    ...
    for i in range(1, max_dim):
        for j in range(iterations):
            ...
            if max_leaf_size is not None:
                learner = primary_learner(learner=dtl.DTLearner, kwargs={"leaf_size":i}, bags=20)
...
if __name__=="__main__":
    ...
    RMSE_in_mean, RMSE_out_mean, CORR_in_mean, CORR_out_mean = computing_RMSE_CORR_TreeLearner(trainX, trainY, testX, testY, primary_learner=dtl.DTLearner, max_leaf_size=max_leaf_size)
    in_sample = RMSE_in_mean
    out_of_sample = RMSE_out_mean
    title = "Figure1. RMSEs of training and testing DTLearner by different leaf size"
    png_file = "Figure1.png"
    xlabel = "Leaf Size"
    ylabel = "RMSE"
    ...
    log.write("Q1: \n")
    log.write("The overfitting occurred at " + str(RMSE_diff_max) + " leaf size.\n\n")
    ...
    log.write("Q2: Leaf size \n")
    log.write("The overfitting occurred at " + str(RMSE_diff_max) + " leaf size.\n\n")

    # Bag size
  
    RMSE_in_mean, RMSE_out_mean, CORR_in_mean, CORR_out_mean = computing_RMSE_CORR_BagLearner(trainX, trainY, testX, testY, primary_learner=bl.BagLearner, max_bag_size=max_bag_size)
    in_sample = RMSE_in_mean
    out_of_sample = RMSE_out_mean
    title = "Figure3. RMSEs of training and testing BagLearner + DTLearner by different bag size"
    png_file = "Figure3.png"
    xlabel = "Bage Size"
    ylabel = "RMSE"

    generate_plot(in_sample, out_of_sample, title, png_file, xlabel, ylabel, legend_loc="lower right", xaxis_length=max_bag_size)

    RMSE_diff = np.subtract(RMSE_in_mean, RMSE_out_mean)
    RMSE_diff_max = np.argmax(RMSE_diff > 0)

    log.write("Q2: Bag size \n")
    log.write("The overfitting occurred at " + str(RMSE_diff_max) + " bag size.\n\n")
    ...
    in_sample = RMSE_in_mean
    out_of_sample = RMSE_out_mean
    title = "Figure4. RMSEs of training and testing DTLearner by different leaf size"
    png_file = "Figure4.png"
    xlabel = "Leaf Size"
    ylabel = "RMSE"
    ...
    in_sample = CORR_in_mean
    out_of_sample = CORR_out_mean
    title = "Figure5. PCC of training and testing DTLearner by different leaf size"
    png_file = "Figure5.png"
    xlabel = "Leaf Size"
    ylabel = "PCC"

    generate_plot(in_sample, out_of_sample, title, png_file, xlabel, ylabel, legend_loc="upper right", xaxis_length=max_leaf_size)

    # rtl
  
    RMSE_in_mean, RMSE_out_mean, CORR_in_mean, CORR_out_mean = computing_RMSE_CORR_TreeLearner(trainX, trainY, testX, testY, primary_learner=rtl.RTLearner, max_leaf_size=max_leaf_size)
    
    in_sample = RMSE_in_mean
    out_of_sample = RMSE_out_mean
    title = "Figure6. RMSEs of training and testing RTLearner by different leaf size"
    png_file = "Figure6.png"
    xlabel = "Leaf Size"
    ylabel = "RMSE"
    ...
    in_sample = CORR_in_mean
    out_of_sample = CORR_out_mean
    title = "Figure7. PCC of training and testing RTLearner by different leaf size"
    png_file = "Figure7.png"
    xlabel = "Leaf Size"
    ylabel = "PCC"
